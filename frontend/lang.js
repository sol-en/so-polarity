const dict = {
    ...
    "Charges": {"en": "Charges", "uk": "Нарахування"},
    "Print": {"en": "Print", "uk": "Друк"},
    "Settings": {"en": "Settings", "uk": "Налаштування"},
    "Administrator": {"en": "Administrator", "uk": "Адміністратор"},
    ...
    "Initial Balance": {"en": "Initial Balance", "uk": "Початковий баланс"},
    "Final Balance": {"en": "Final Balance", "uk": "Кінцевий баланс"},
    "Balance: Actual vs Forecast": {"en": "Balance: Actual vs Forecast", "uk": "Баланс: факт та прогноз"},
    "Details Breakdown": {"en": "Details Breakdown", "uk": "Деталізація"},
    "Initiatives Availability": {"en": "Initiatives Availability", "uk": "Доступність ініціатив"},
    "Add Initiative": {"en": "Add Initiative", "uk": "Додати ініціативу"},
    "Scenario Parameters and Details": {"en": "Scenario Parameters and Details", "uk": "Параметри та деталізація сценарію"},
    "Current Balance": {"en": "Current Balance", "uk": "Поточний баланс"},
    "Tariff (₴/m²)": {"en": "Tariff (₴/m²)", "uk": "Тариф (₴/м²)"},
    "Expected Collection": {"en": "Expected Collection", "uk": "Очікуваний збір"},
    "Update": {"en": "Update", "uk": "Оновити"},
    "Debtors (Top 10)": {"en": "Debtors (Top 10)", "uk": "Боржники (ТОП-10)"},
    "Expenses: Breakdown": {"en": "Expenses: Breakdown", "uk": "Витрати: розбивка"},
    "Apartment": {"en": "Apartment", "uk": "Квартира"},
    "Owner": {"en": "Owner", "uk": "Власник"},
    "Debt": {"en": "Debt", "uk": "Борг"},
    "Group": {"en": "Group", "uk": "Група"},
    "Amount": {"en": "Amount", "uk": "Сума"},
    "Total": {"en": "Total", "uk": "Всього"},
    "Other": {"en": "Other", "uk": "Решта"},
    "Type": {"en": "Type", "uk": "Тип"},
    "Purpose": {"en": "Purpose", "uk": "Призначення"},
    "Dashboard error": {"en": "Dashboard error", "uk": "Помилка дашборду"},
    "Inflows": {"en": "Inflows", "uk": "Надходження"},
